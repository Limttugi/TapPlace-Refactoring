...
import PolicyTermsTemplate from '@/components/_Templates/PolicyTermsTemplate/PolicyTermsTemplate';

const TermsConditions = () => {
  return (
    <>
      <Head>
        <title>탭플레이스 - 이용약관</title>
      </Head>
      <PolicyTermsTemplate>
        <section className={s.container}>
          ...
          <article className={s.nJoWrapper}>
            ...
            <ul className={s.nJoContentContainer}>
              ...
              <ul className={s.nJoContentSubContainer}>
                ...
                <li className={s.nJoContent}>
                  3. &quot;결제수단이라 함은 &quot;앱&quot;을 통해 제공되는 서비스 정보(네이버페이, 카카오페이,
                  제로페이, 페이코, 애플페이, 구글페이, 컨택리스)를 통틀어 말합니다.
                </li>
                <li className={s.nJoContent}>
                  4. &quot;모바일 기기&quot;란 콘텐츠를 다운로드 받거나 설치하여 사용할 수 있는 기기로서, 휴대폰,
          ...
          <article className={s.nJoWrapper}>
            ...
            <ul className={s.nJoContentContainer}>
              ...
              <li className={s.nJoContent}>
                ② 당사는 불가피한 여건이나 사정이 있을 경우 「약관의 규제에 관한 법률」, 「정보통신망이용촉진 및
                정보보호 등에 관한 법률」등 관련 법령에 위배하지 않는 범위에서 이 약관을 개정할 수 있습니다.
              </li>
              <li className={s.nJoContent}>
                ③ 당사가 약관을 개정할 경우에는 적용일자 및 개정내용, 개정사유 등을 명시하여 최소한 그 적용일 7일
                이전부터 &quot;앱&quot; 내 또는 그 연결화면에 게시하여 이용자에게 공지합니다. 다만, 변경된 내용이
                이용자에게 불리하거나 중대한 사항의 변경인 경우에는 그 적용일 30일 이전까지 본문과 같은 방법으로
                공지합니다. 이 경우 개정 전 내용과 개정 후 내용을 명확하게 비교하여 이용자가 알기 쉽도록 표시합니다.
              </li>
              <li className={s.nJoContent}>
                ④ 당사가 약관을 개정할 경우 개정약관 공지 후 개정약관의 적용에 대한 이용자의 동의 여부를 확인합니다.
          ...
          <article className={s.nJoWrapper}>
            ...
            <ul className={s.nJoContentContainer}>
              <li className={s.nJoContent}>
                ① 이용자는 &quot;앱&quot;에서 약관을 동의하여 &quot;앱&quot;에서 정한 양식에 따라 이용자 정보를 기입을
                하면, 당사는 이러한 신청을 승낙하여 이용자 등록이 완료 됩니다.
              </li>
              <li className={s.nJoContent}>
                ② 당사는 원칙적으로 전 항에 따라 이용자 등록에 대하여 승낙함을 원칙으로 합니다.
              </li>
              <li className={s.nJoContent}>
                ③ 이용자는 가입시 등록한 이용자정보의 변경이 발생한 경우, 즉시 전자우편 등을 통하여 당사로 변경을 요청할
                수 있습니다.
              </li>
            </ul>
          </article>
          <article className={s.nJoWrapper}>
            ...
            <ul className={s.nJoContentContainer}>
              <li className={s.nJoContent}>
                ...
                &quot;앱&quot;내에 저장된 이용 기록은 즉시 삭제되며, 당사에 저장되어있는 개인정보 또한 삭제됩니다.
                삭제가 진행 된 이후 복구가 불가능하게 됩니다.
              </li>
              <li className={s.nJoContent}>
                ② 당사는 이용자가 이 약관이 금지하거나 공서양속에 반하는 행위를 하는 등 본 계약을 유지할 수 없는 중대한
                사유가 있는 경우에는 이용자에게 통지하고, 서비스 이용을 제한․중지하거나 이용자 자격을 상실시킬 수
                있습니다.
              </li>
              <li className={s.nJoContent}>
                ③ 당사가 이용자자격을 상실시키는 경우에는 이용자 등록을 말소합니다. 이 경우 이용자에게 이를 통지하고,
                이용자 등록 말소 전에 소명할 기회를 부여합니다.
              </li>
              <li className={s.nJoContent}>
                ④ 당사는 최근의 서비스 이용일부터 연속하여 1년 동안 당사의 서비스를 이용하지 않은 이용자의 개인정보를
                보호하기 위해 이용계약을 해지하고 이용자의 개인정보를 파기 등의 조치를 취할 수 있습니다. 이 경우 조치일
                30일 전까지 계약 정지 또는 해지, 개인정보 파기 등의 조치가 취해진다는 사실 및 파기될 개인정보 등을
                이용자에게 통지합니다.
              </li>
            </ul>
          </article>
          <article className={s.nJoWrapper}>
            ...
            <ul className={s.nJoContentContainer}>
              ...
              <li className={s.nJoContent}>
                ② 당사는 불특정다수 이용자에 대한 통지의 경우 30일 이상 &quot;앱&quot;에 게시함으로서 개별 통지에 갈음
                할 수 있습니다.
              </li>
            </ul>
          </article>
          <article className={s.nJoWrapper}>
            ...
            <ul className={s.nJoContentContainer}>
              ...
              <li className={s.nJoContent}>
                ③ 당사는 계속적이고 안정적인 서비스의 제공을 위하여 서비스 개선을 하던 중 설비에 장애가 생기거나 데이터
                등이 멸실, 훼손된 때에는 천재지변, 비상사태, 현재의 기술로는 해결이 불가능한 장애나 결함 등 부득이한
          ...
          <article className={s.nJoWrapper}>
            ...
            <ul className={s.nJoContentContainer}>
              ...
              <ul className={s.nJoContentSubContainer}>
                ...
                <li className={s.nJoContent}>
                  2. 당사의 운영자를 가장하거나 다른 이용자 또는 제3자의 명의를 도용하여 메일을 발송하는 행위, 다른
                  이용자 또는 제3자로 가장하거나 제3자와의 관계를 허위로 명시하는 행위
                </li>
                <li className={s.nJoContent}>
                ...
                <li className={s.nJoContent}>
                  6. 다른 이용자 또는 제3자를 기망하여 이득을 취하는 행위, 당사의 서비스의 이용과 관련하여 타인에게
                  피해를 입히는 행위
                </li>
                <li className={s.nJoContent}>
                ...
                <li className={s.nJoContent}>
                  9. 당사로부터 특별한 권리를 부여받지 않고 앱을 변경하거나, 앱에 다른 프로그램을 추가⋅삽입하거나,
                  서버를 해킹⋅역설계하거나, 소스 코드나 애플리케이션 데이터를 유출⋅변경하거나, 별도의 서버를 구축하거나,
              ...
              <li className={s.nJoContent}>
                ② 이용자의 개인정보, &quot;앱&quot;이 설치된 모바일 기기에 관한 관리책임은 이용자에게 있으며, 이용자의
                과실 및 기타 타인의 불법행위로 인한 이용자정보, 이용자가 &quot;앱&quot;에 등록한 정보가 유출되는 경우
                당사는 책임지지 않습니다.
              </li>
          ...
          <article className={s.nJoWrapper}>
            ...
            <ul className={s.nJoContentContainer}>
              <li className={s.nJoContent}>
                ① &quot;앱&quot;은 다음과 같은 서비스를 이용자에게 제공합니다. 단, 당사가&quot;앱&quot;으로 제공하는
                서비스 이용을 위해 필요시 이용자에게 위치정보이용약관 및 개인정보 제공에 관한 동의를 추가로 요구할 수
                있으며, 동의하지 않을 경우 서비스의 전부 또는 일부가 제한될 수 있습니다.
              </li>
              <ul className={s.nJoContentSubContainer}>
                ...
                <li className={s.nJoContent}>
                  ...
                  경우에는 서비스의 제공을 일시적으로 중단할 수 있습니다. 다만, 서비스 중단의 경우 당사는 “앱”을 통해
                  이를 고지합니다.
                </li>
              </ul>
            </ul>
          ...
          <article className={s.nJoWrapper}>
            ...
            <ul className={s.nJoContentContainer}>
              ...
              <li className={s.nJoContent}>
                ③ 당사는 관련 법령에 의하거나, 관련 국가기관 등의 요청이 있는 경우를 제외하고는 이용자의 개인정보를
                본인의 동의 없이 제3자에게 제공하지 않습니다.
              </li>
              <li className={s.nJoContent}>
                ④ 이용자는 언제든지 당사가 가지고 있는 자신의 개인정보에 대해 열람 및 오류정정 또는 동의 철회를 요구할
          ...
          <article className={s.nJoWrapper}>
            ...
            <ul className={s.nJoContentContainer}>
              ...
              <li className={s.nJoContent}>
                ③ 서비스와 관련하여 게재된 정보나 자료 등의 신뢰성, 정확성 등에 대하여 당사는 고의 또는 중대한 과실이
                없는 한 책임을 지지 않습니다.
              </li>
              <li className={s.nJoContent}>
              ...
              <li className={s.nJoContent}>
                ⑤ 당사는 이용자가 서비스를 이용하여 기대하는 이익을 얻지 못하거나 상실한 것에 대하여 책임을 지지
                않습니다.
              </li>
              <li className={s.nJoContent}>
          ...
          <article className={s.nJoWrapper}>
            ...
            <ul className={s.nJoContentContainer}>
              ...
              <li className={s.nJoContent}>
                ...
                정보를 당사 또는 제공업체의 사전 동의 없이 복제⋅전송 등의 방법(편집, 공표, 공연, 배포, 방송, 2차적
                저작물 작성 등을 포함합니다. 이하 같습니다)에 의하여 영리목적으로 이용하거나 타인에게 이용하게 하여서는
                안 됩니다.
              </li>
              <li className={s.nJoContent}>
          ...
          <article className={s.nJoWrapper}>
            ...
            <ul className={s.nJoContentContainer}>
              ...
              <li className={s.nJoContent}>
                ② 당사는 이용자로부터 제기되는 의견이나 불만이 정당하다고 객관적으로 인정될 경우에는 합리적인 기간 내에
