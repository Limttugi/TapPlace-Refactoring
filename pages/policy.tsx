        ...
        <section className={s.container}>
          ...
          <article className={s.nJoWrapper}>
            <p className={s.open}>
              ...
              보호법」 제30조에 따라 정보주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수
          ...
          <article className={s.nJoWrapper}>
            ...
            <ul className={s.nJoContentContainer}>
              <li className={s.nJoContent}>
                {`< 탭플레이스 >`}(&apos;https://www.tapplace.co.kr&apos;이하 &apos;탭플레이스&apos;)은(는) 다음의
              ...
              <li className={`${s.nJoContent} ${s.nJoContentSubContainer}`}>
                2. 사용 통계 지표 확인
                <div className={s.nJoContent}>
                  사용자의 이용 빈도 및 통계의 지표 확인 목적으로 개인정보를 처리합니다.
                </div>
              </li>
              <li className={`${s.nJoContent} ${s.nJoContentSubContainer}`}>
                3. 민원사무 처리
          ...
          <article className={s.nJoWrapper}>
            ...
            <ul className={s.nJoContentContainer}>
              <li className={s.nJoContent}>
                ① {`< 탭플레이스 >`} 은(는) 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가 불필요하게 되었을
          ...
          <article className={s.nJoWrapper}>
            ...
            <ul className={s.nJoContentContainer}>
              ...
              <li className={s.nJoContent}>
                ② 제1항에 따른 권리 행사는탭플레이스에 대해 「개인정보 보호법」 시행령 제41조제1항에 따라 서면,
              ...
              <li className={s.nJoContent}>
                ⑥ 탭플레이스은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구, 처리정지의 요구 시 열람 등 요구를
          ...
          <article className={s.nJoWrapper}>
            ...
            <ul className={s.nJoContentContainer}>
              ...
              <ul className={s.nJoContentSubContainer}>
                <li className={s.nJoContent}>
                  1. 개인정보 취급 직원의 최소화 및 교육개인정보를 취급하는 직원을 지정하고 담당자에 한정시켜 최소화
                  하여 개인정보를 관리하는 대책을 시행하고 있습니다.
                </li>
                <li className={s.nJoContent}>
                  2. 내부관리계획의 수립 및 시행개인정보의 안전한 처리를 위하여 내부관리계획을 수립하고 시행하고
                  있습니다.
                </li>
                <li className={s.nJoContent}>
                  3. 접속기록의 보관 및 위변조 방지개인정보처리시스템에 접속한 기록을 최소 1년 이상 보관, 관리하고
                  있으며,다만, 5만명 이상의 정보주체에 관하여 개인정보를 추가하거나, 고유식별정보 또는 민감정보를
                  처리하는 경우에는 2년이상 보관, 관리하고 있습니다.또한, 접속기록이 위변조 및 도난, 분실되지 않도록
                  보안기능을 사용하고 있습니다.
                </li>
                <li className={s.nJoContent}>
